...
import { Activity, AlertTriangle, BarChart2, Calendar, Camera, Cpu, Download, Filter, HardDrive, Network, Search, Server, ShieldAlert, Video, Zap } from 'lucide-react'
    ...
    <div className="p-8 h-full overflow-y-auto">
      <div className="flex justify-between items-end mb-8">
        ...
        <div className="flex gap-2">
          ...
          <a href="http://localhost:8000/report/pdf" download="security_report.pdf" className="flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg text-sm font-medium hover:bg-primary/90 transition-colors shadow-lg shadow-primary/20">
