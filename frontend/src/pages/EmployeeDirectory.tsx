          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex gap-2">
              <button 
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-teal-500 to-emerald-600 text-white rounded-lg hover:from-teal-400 hover:to-emerald-500 transition-all font-medium shadow-[0_0_20px_rgba(20,184,166,0.3)] hover:shadow-[0_0_30px_rgba(20,184,166,0.5)] border border-white/10"
              >
              ...
              <div className="w-full mt-2">
                ...
                <div className="flex bg-black/50 border border-white/10 rounded-lg overflow-hidden focus-within:border-primary transition-colors">
                  ...
                  <button 
                    ...
                    className="bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-400 px-3 transition-colors flex items-center justify-center border-l border-white/10"
                  >
                    Copy
                  </button>
                </div>
